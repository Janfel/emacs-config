...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
	(yaml-mode yasnippet-snippets which-key use-package smex smartparens slime python-black org-bullets nord-theme neotree move-text lua-mode lsp-ui live-preview latex-preview-pane hungry-delete haskell-mode goto-line-preview goto-chg format-all form-feed folding flycheck-rust flycheck-joker flycheck-inline flycheck-clojure doom-themes diminish delight counsel company-lsp company-jedi company-auctex cargo auto-package-update auto-complete async amx all-the-icons 2048-game)))
